...
class SOLOv2_9point_Head(nn.Module):
    ...
    def forward_single(self, x, idx, eval=False, upsampled_size=None):
        ...
        # 生成kernerl 的特征cat 坐标
        # [2, 258, 40, 40] 这里就直接把kernel feat 缩放了
        ...
        # 这里又加一层卷积，为什么不写到一起呢. 类别需要一个卷积，这里也搭配上一个
    ...
    def loss(self,
        ...
        # 这里输入的maskkernel是40x40的，那被卷积的在哪
        # 另外这里把操作写到loss里边，测试的时候怎么办
        # solo 里边，这个函数中直接就用输入的特征进行loss计算了
        # 这个 ins_pred哪来的。好吧，这里是在函数之外加了个if判断是否需要传入被卷积特征
